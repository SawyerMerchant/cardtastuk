...
import { Grid, Row, Col, Tabs, Tab, Panel, FormControl, FormGroup, ControlLabel, Button } from 'react-bootstrap';
              ...
              <Panel header={"Register for an account today."}>
                <form onSubmit={onRegister}>
                  ...
                  <FormGroup controlId="password_confirmation">
                    ...
                    <FormControl type="password" name="password_confirmation" required/>
                  </FormGroup>
                  <Button bsStyle="success" type="submit">Register for an Account</Button>
                </form>
              </Panel>
            </Tab>
